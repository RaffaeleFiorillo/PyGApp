...
class BasicInputManager(BaseInterface):
    def __init__(self, screen, buttons: [MainMenuButton] = None):
        super().__init__(screen)
        # self.button_activation_sound = button_y_sound
        self.clock = pygame.time.Clock()
        self.button_list = buttons if buttons is not None else []
        self.active_code = 0
    ...
    def update_coord_effect(self) -> (int, int):
